  ...
  return (
    <div className="pt-8 pb-40 px-6 max-w-6xl mx-auto relative z-10">
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="relative p-6 bg-white/[0.01] rounded-lg flex flex-col justify-center w-full sm:w-auto min-w-[240px] overflow-hidden">
          {/* Table Header */}
          <div className="hidden md:grid grid-cols-[2fr_0.7fr_1fr_1fr_1fr_1fr] p-6 border-b border-white/[0.05] bg-white/[0.01]">
            <div className="text-[10px] font-black text-white/30 uppercase tracking-widest">Pool</div>
            <div className="text-[10px] font-black text-white/30 uppercase tracking-widest text-right">Fee Tier</div>
            <div className="text-[10px] font-black text-white/30 uppercase tracking-widest text-right">Liquidity</div>
            <div className="text-[10px] font-black text-white/30 uppercase tracking-widest text-right">Pool APR</div>
            <div className="text-[10px] font-black text-white/30 uppercase tracking-widest text-right">1D Vol</div>
            <div className="text-[10px] font-black text-white/30 uppercase tracking-widest text-right">30D Vol</div>
          </div>
          ...
          {filteredPools.map((pool) => {
            ...
            return (
              <div
                ...
                className="grid grid-cols-1 md:grid-cols-[2fr_0.7fr_1fr_1fr_1fr_1fr] p-6 items-center border-b border-white/[0.05] hover:bg-white/[0.03] transition-all duration-300 group last:border-0 cursor-pointer"
              >
                {/* Pool */}
