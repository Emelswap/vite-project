      ...
      <div className="w-full max-w-[480px]">      
        ...
        <div className="glass-morphism p-6 rounded-2xl border border-white/5 bg-white/[0.01] shadow-2xl relative">
          <div className="space-y-2">
            {/* From Token */}
            <div className="bg-white/[0.03] p-6 rounded-xl border border-white/5 hover:border-white/10 transition-all">
              ...
              <div className="flex items-center justify-between gap-4">
                <input 
                  ...
                  className="bg-transparent border-none p-0 text-3xl font-black text-white focus:ring-0 w-full placeholder:text-white/10"
                  placeholder="0.00"
                />
            ...
            <div className="flex justify-center -my-6 relative z-10">
              <button className="w-10 h-10 bg-black border border-white/10 rounded-xl flex items-center justify-center text-primary shadow-xl hover:scale-110 active:scale-95 transition-all">
            ...
            <div className="bg-white/[0.03] p-6 rounded-xl border border-white/5 hover:border-white/10 transition-all">
              ...
              <div className="flex items-center justify-between gap-4">
                <input 
                  ...
                  value={toAmount}
                  readOnly
                  className="bg-transparent border-none p-0 text-3xl font-black text-white/40 focus:ring-0 w-full"
                  placeholder="0.00"
                />
                <button className="flex items-center gap-2 bg-white/5 hover:bg-white/10 px-4 py-2 rounded-full border border-white/10 transition-all shrink-0">
                  <div className="w-6 h-6 rounded-full bg-white/10 overflow-hidden">
