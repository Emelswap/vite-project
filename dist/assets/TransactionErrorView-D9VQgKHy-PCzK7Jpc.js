import{o as e}from"./chunk-CFjPhJqf.js";import{n as t,t as n}from"./jsx-runtime-QQLjLlGf.js";import{xn as r}from"./ccip-B0s9EJQ8.js";import{O as i,Y as a,er as o,pn as s}from"./useActiveWallet-CLfuK4Fv-Dh_QcYZ1.js";import{t as c}from"./formatters-BLEs-z7i.js";import{a as l,c as u,f as d,i as f,l as p,r as m}from"./ModalHeader-BxZPF7qd-CmccXhPF.js";import{t as ee}from"./ChevronDownIcon-DEDigUbK.js";import{n as h,t as g}from"./Checkbox-BhNoOKjX-DI9NXHrF.js";import{t as _}from"./ExclamationCircleIcon-BjQ74_LT.js";import{t as v}from"./ErrorMessage-D8VaAP5m-BRyb2uTg.js";import{a as y,i as b,n as x,r as te,t as S}from"./Value-tcJV9e0L-Q4fOOtUy.js";import{t as C}from"./LoadingSkeleton-U6-3yFwI-BQUasgDk.js";import{t as ne}from"./Subtitle-CV-2yKE4-DMJm4YgZ.js";import{t as w}from"./Title-BnzYV3Is-CDQBlIZn.js";import{t as T}from"./shared-FM0rljBt-DYW9A4we.js";import{t as E}from"./Address-DjnW56Bj-B4imMqHD.js";import{t as D}from"./LabelXs-oqZNqbm_-DOty_Iud.js";import{t as O}from"./WalletInfoCard-D5bstd0h-yhDb43uF.js";import{t as k}from"./WarningBanner-D5LqDt95-Dpazhle_.js";import{t as A}from"./ErrorBanner-CQERa7bL--wtgz3_g.js";var j=e(t());function M({title:e,titleId:t,...n},r){return j.createElement(`svg`,Object.assign({xmlns:`http://www.w3.org/2000/svg`,fill:`none`,viewBox:`0 0 24 24`,strokeWidth:1.5,stroke:`currentColor`,"aria-hidden":`true`,"data-slot":`icon`,ref:r,"aria-labelledby":t},n),e?j.createElement(`title`,{id:t},e):null,j.createElement(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z`}))}var re=j.forwardRef(M);function N({title:e,titleId:t,...n},r){return j.createElement(`svg`,Object.assign({xmlns:`http://www.w3.org/2000/svg`,fill:`none`,viewBox:`0 0 24 24`,strokeWidth:1.5,stroke:`currentColor`,"aria-hidden":`true`,"data-slot":`icon`,ref:r,"aria-labelledby":t},n),e?j.createElement(`title`,{id:t},e):null,j.createElement(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5A3.375 3.375 0 0 0 6.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0 0 15 2.25h-1.5a2.251 2.251 0 0 0-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 0 0-9-9Z`}))}var P=j.forwardRef(N),F=n(),I=a(S)`
  cursor: pointer;
  display: inline-flex;
  gap: 8px;
  align-items: center;
...
`,B=a.img`
  ...
  margin-right: 4px;
  object-fit: contain;
`,ie=e=>{let{chain:t,transactionDetails:n,isTokenContractInfoLoading:i,symbol:a}=e,{action:o,functionName:s}=n;return(0,F.jsx)(T,{children:(0,F.jsxs)(y,{children:[o!==`transaction`&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Action`}),(0,F.jsx)(x,{children:s})]}),s===`mint`&&`args`in n&&n.args.filter((e=>e)).map(((e,n)=>(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Param ${n}`}),(0,F.jsx)(x,{children:typeof e==`string`&&r(e)?(0,F.jsx)(E,{address:e,url:t?.blockExplorers?.default?.url,showCopyIcon:!1}):e?.toString()})]},n))),s===`setApprovalForAll`&&n.operator&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Operator`}),(0,F.jsx)(x,{children:(0,F.jsx)(E,{address:n.operator,url:t?.blockExplorers?.default?.url,showCopyIcon:!1})})]}),s===`setApprovalForAll`&&n.approved!==void 0&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Set approval to`}),(0,F.jsx)(x,{children:n.approved?`true`:`false`})]}),s===`transfer`||s===`transferWithMemo`||s===`transferFrom`||s===`safeTransferFrom`||s===`approve`?(0,F.jsxs)(F.Fragment,{children:[`formattedAmount`in n&&n.formattedAmount&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Amount`}),(0,F.jsxs)(x,{$isLoading:i,children:[n.formattedAmount,` `,a]})]}),`tokenId`in n&&n.tokenId&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Token ID`}),(0,F.jsx)(x,{children:n.tokenId.toString()})]})]}):null,s===`safeBatchTransferFrom`&&(0,F.jsxs)(F.Fragment,{children:[`amounts`in n&&n.amounts&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Amounts`}),(0,F.jsx)(x,{children:n.amounts.join(`, `)})]}),`tokenIds`in n&&n.tokenIds&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Token IDs`}),(0,F.jsx)(x,{children:n.tokenIds.join(`, `)})]})]}),s===`approve`&&n.spender&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Spender`}),(0,F.jsx)(x,{children:(0,F.jsx)(E,{address:n.spender,url:t?.blockExplorers?.default?.url,showCopyIcon:!1})})]}),(s===`transferFrom`||s===`safeTransferFrom`||s===`safeBatchTransferFrom`)&&n.transferFrom&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Transferring from`}),(0,F.jsx)(x,{children:(0,F.jsx)(E,{address:n.transferFrom,url:t?.blockExplorers?.default?.url,showCopyIcon:!1})})]}),(s===`transferFrom`||s===`safeTransferFrom`||s===`safeBatchTransferFrom`)&&n.transferTo&&(0,F.jsxs)(b,{children:[(0,F.jsx)(S,{children:`Transferring to`}),(0,F.jsx)(x,{children:(0,F.jsx)(E,{address:n.transferTo,url:t?.blockExplorers?.default?.url,showCopyIcon:!1})})]})]})})},V=({variant:e,setPreventMaliciousTransaction:t,colorScheme:n=`light`,preventMaliciousTransaction:r})=>e===`warn`?(0,F.jsx)(H,{children:(0,F.jsxs)(k,{theme:n,children:[(0,F.jsx)(`span`,{style:{fontWeight:`500`},children:`Warning: Suspicious transaction`}),(0,F.jsx)(`br`,{}),`This has been flagged as a potentially deceptive request. Approving could put your assets or funds at risk.`]})}):e===`error`?(0,F.jsx)(F.Fragment,{children:(0,F.jsxs)(H,{children:[(0,F.jsx)(A,{theme:n,children:(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`strong`,{children:`This is a malicious transaction`}),(0,F.jsx)(`br`,{}),`This transaction transfers tokens to a known malicious address. Proceeding may result in the loss of valuable assets.`]})}),(0,F.jsxs)(U,{children:[(0,F.jsx)(g,{color:`var(--privy-color-error)`,checked:!r,readOnly:!0,onClick:()=>t(!r)}),(0,F.jsx)(`span`,{children:`I understand and want to proceed anyways.`})]})]})}):null,H=a.div`
  margin-top: 1.5rem;
`,U=a.div`
  display: flex;
  align-items: center;
